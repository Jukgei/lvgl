...
static lv_coord_t get_header_height(lv_obj_t * calendar)
{
    ...
    printf("font height: %d, margin_top: %d,  pad top: %d, margin_bottom:%d, pad_bottom: %d\n", lv_font_get_line_height(font),
        lv_obj_get_style_margin_top(calendar, LV_CALENDAR_PART_HEADER),
        lv_obj_get_style_pad_top(calendar, LV_CALENDAR_PART_HEADER),
        lv_obj_get_style_margin_bottom(calendar, LV_CALENDAR_PART_HEADER),
        lv_obj_get_style_pad_bottom(calendar, LV_CALENDAR_PART_HEADER));
